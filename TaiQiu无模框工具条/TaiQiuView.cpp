...
//	if(!logindlg.m_userid.IsEmpty())
//	{
//		mesg.Format("%c%c%s,%s,", MSG_REGISTER, 'a', logindlg.m_userid, logindlg.m_passwd);
//		CSockAddr psa = CSockAddr(ServerIP, ServerPt);
